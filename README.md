## Personal fork of Axel Johansson's AxxSolder
> [!NOTE]
> The purpose of this fork is not to continue the development of the offical [AxxSolder](https://github.com/AxxAxx/AxxSolder)
> but rather for some personal graphical and functional changes for my own taste. If you stumbled upon this and are interested
> in the AxxSolder project, please check out the original repository and [shop](https://www.5dimensions.se/) of Axel Johansson
> to support the project. All credits belong to him and the open-source contributers of the original project.
